  ...
  <q-page class="page">
    <div class="container">
      ...
      <q-breadcrumbs-el label="Галерея" />
        ...
        <p class="text-fs18 text-avenir-450 q-mb-xl">Все наши картины - это репродукции с оцифрованных в качестве 300 dpi оригиналов. Оцифровка, и последующая печать, выполнена на так называемом музейном оборудовании. Все работы напечатаны на бельгийской и немецкой эко бумаге, доведены вручную, и покрыты лаком для лучшей защиты и восприятия, их не обязательно ставить под стекло. Картины продаются полностью оформленные, в паспарту, задник и раму без стекла. </p>
      ...
      <div class="gallery-grid">
        <router-link :to="{name:'item'}" v-for="(slide,index) in gallerySlides" :key="index">
