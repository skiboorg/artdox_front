  ...
  <q-page class="page">
    <div class="container">
      ...
      <p class="text-fs18 text-avenir-450 q-mb-xl">
       Все наши картины - это репродукции с оцифрованных в качестве 600 - 1200 dpi оригиналов. Оцифровка, и последующая печать, выполнена на самом современном оборудовании. Все работы напечатаны на французской и немецкой хлопковой бумаге, доработаны и покрыты лаком для лучшей защиты и восприятия, их не обязательно ставить под стекло. Картины продаются в нашей фирменной коробке, с сертификатом от автора.
<br><br>
В последующем, вся Коллекция будет  оформлена в формате NFT  - "несменяемый токен" и представлена на маркетплейсе BINANCE.
      </p>
...
<!--      <p class="text-dark text-fs18 q-mb-xl">Репродукция – <span class="text-grey-7">от 50 000 ₽ до 140 000 ₽</span></p>-->
  ...
  <q-dialog
    v-model="modal"
  >
    <q-card class="relative-position" style="width: 700px; max-width: 80vw; height: auto">
      <q-btn v-close-popup class="absolute-top-right z-max" icon="close" round flat/>
