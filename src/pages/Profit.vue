      ...
      <div class="row">
        <div class="col-12 col-md-8 ">
          <p class="no-margin text-avenir-300">
            ...
            <br><br>
            От китайской стороны стабильно получаем 10 Юаней (1,5 $) в сутки за каждую картину, из расчета 300 экспозиционных дней в году.
            <br><br>
            Также открыты пункты продаж репродукций в этих местах. Необходимое количество экспозиций в год не менее 10 (300 картин), и эти потребности в Китае постоянно растут.
            <br><br>
