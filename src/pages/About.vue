        ...
        <div class="row q-col-gutter-md-xl">
          <div class=" col-12 col-md-7">
            <p class="q-mb-none text-lh-200">
              Наша Команда специалистов в области искусства, менеджмента и маркетинга, в партнерстве с китайской компанией ArtBooklet LTD. (лицензия), предлагает Вам абсолютно новый подход к продажам предметов искусства.  <br><br>

              Вся наша деятельность нацелена на то, чтобы предмет искусства приносил своему владельцу не только эстетическое удовольствие, но и материальное благополучие. Гораздо приятней смотреть на картину и знать, что деньги, потраченные на ее приобретение, не только возможно вернуть, но и приумножить.
            </p>
          </div>
    ...
    <section class="interier">
      <div style="margin-bottom: 35px" class="container">
        ...
        <div class="row">
          ...
          Мы, Artdox при поддержке китайской компании ArtBooklet Ltd,  начали свою экспозиционную деятельность в городе Ханчджоу — центре академического искусства Китая. На выставочных площадках города разместили свою первую экспозицию, посвященную флоре и фауне Южной Америки.
        </p>
        </div>
        ...
        <div style="margin-bottom: 25px" class="interier-grid">
          <div @click="modalImg = 'about' + (index+1) + '.jpg',modal=true" class="overlay-img" v-for="(i,index) in 3" :key="i">
            <img class="img" :src="`about${index+1}.jpg`" alt="">
