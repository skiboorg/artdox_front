    ...
    <div class="container">
      <div class="">
       ...
       <div class="lk-card-title">
        <p class="no-margin text-fs18 text-avenir-600">Запрос на возврат картины</p>
      </div>
...
<br><br>
Денежные средства будут перечислены по указанным реквизитам в течении 24 часов с момента формирования заявки. Так же мы в ответном письме укажем вам номер отделения СДЭКа, куда вам будет необходимо отправить вашу картину для возврата.</p>
