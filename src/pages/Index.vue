  ...
  <q-page>
    ...
    <section class="about">
      <div class="container">
        ...
        <p class="text-h6 text-avenir-450 text-lh-150 q-mb-lg q-mb-lg-xl">
          Каждая картина, купленная у нас, имеет доходность 24% в год, каждый квартал вы получаете 6% от суммы покупки. Возврат картины и средств возможен в любое время.
        </p>
...
export default {
  ...
  data(){
    return{
      ...
      offerSlides:[
        {title:'Доходное искусство',text:'Наши картины, как облигации на фондовом рынке, всегда приносят гарантированный доход своему владельцу.',img:'slide1.png'},
         {title:'Доходное искусство слайд1',text:'1Наши картины, как облигации на фондовом рынке, всегда приносят гарантированный доход своему владельцу.',img:'slide2.jpg'},
