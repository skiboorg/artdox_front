        ...
        <div class="cart-item" v-for="item in cart.items" :key="item.id">
          <div class="item-card q-mb-lg">
            <div class="overlay-img bordered" >
              <img class="img" :src="item.image_thumb" alt="">
            ...
            <div class="">
              <div class="flex items-start justify-between q-mb-md">
                <p class="no-margin text-playfair text-h5 text-dark">«{{item.name}}»</p>
                <p class="no-margin text-warning text-fs18 q-mb-none text-avenir-450">{{item.price}} ₽</p>
              </div>
