      ...
      <div class="overlay-img bordered" >
        ...
        <div class="">
          <div class="flex items-start justify-between q-mb-md">
             <p class="no-margin text-playfair text-h5 text-dark">«Утро в лесу»</p>
             <p class="no-margin text-warning text-fs18 q-mb-none text-avenir-450">38000 ₽</p>
          </div>
        ...
        <p class="text-caption text-grey q-mb-lg-xl">Размер 40х60 см</p>
          ...
          <q-btn class="q-px-lg " size="18px" color="dark" rounded unelevated no-caps text-color="white" label="Купить с Доходом"/>
        </div>
         <div class="cart-item">
            <div class="item-card q-mb-lg">
      <div class="overlay-img bordered" >
